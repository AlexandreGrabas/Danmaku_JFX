...
public class StageEndTableauScore extends AbstractStage {
    ...
    public StageEndTableauScore(InputManager input, Canvas canvas,Player player, SoundManager soundManager) {
        this.input = input;
        this.canvas = canvas;
        this.hudCanvas = null;
        this.player=player;
    ...
    public void render(GraphicsContext gc) {
        ...
        if(this.player instanceof PlayerEllie){
        ...
        }else if(this.player instanceof PlayerErwin){
