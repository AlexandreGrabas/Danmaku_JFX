...
public class Stage2 extends AbstractStage{
    ...
    public Stage2(InputManager inputManager, Canvas canvas, Player player) {
    ...
    private void affichagePause(GraphicsContext gc){   
    ...
    private void affichageBossDead(GraphicsContext gc){
