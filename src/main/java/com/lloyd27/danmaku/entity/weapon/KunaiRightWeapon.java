...
import com.lloyd27.danmaku.entity.Bullet.KunaiRightBullet;

import java.util.ArrayList;

public class KunaiRightWeapon extends AbstractWeapon {
    protected double fireRate = 0.01; // secondes entre tirs

    public KunaiRightWeapon(){
        this.fireRate=0.5;
    }

    public KunaiRightWeapon(double fireRate){
    ...
    public List<AbstractBullet> shoot(double x, double y) {
        ...
        bullets.add(new KunaiRightBullet(x, y, +250, 0,"enemy")); // tire vers ladroite
        return bullets;
    }
